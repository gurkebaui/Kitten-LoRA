...
smol: bool = True  # Setze auf True für das kleine Modell (0.6B), False für 1.7B
...
def main():
    ...
    checkpoint_path = Path("/home/henry/Documents/Kitten-LoRA/models/kitten_simple/best") if smol else Path("/home/henry/Documents/Kitten-LoRA/models/kitten_simple_big/best")
    
    if checkpoint_path.exists():
        if model.load_hope_weights(str(checkpoint_path)):
            print("✅ Gewichte geladen (Simple HOPE).") if smol else print("✅ Gewichte geladen (Simple Big HOPE).")
        else:
